...
class RecordTestCase(TestCase):
    ...
    def test_record_gets_pot_amount_before_after_all_records_for_day(self):
        ...
        recursive_result = Record.get_oldest_amount_from_list(records, pot.amount)
    ...
    def test_pot_gets_total_records_summaries(self):
        """Pot can be return pot amounts from particular dates"""
        user = get_user_model().objects.get(username="samad")
        pot = Pot.objects.get(name="SamplePot1")
        ...
        result = Record.fetch_pot_total_from(pot, last_week.date(), Transaction.Period.DAY) 
        expected_list_amounts = [100, 110, 110, 110, 110, 200, 200]
